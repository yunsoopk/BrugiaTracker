...
clear wellplate_tracking_script_test; close all;
...
start_index = 1;
end_index = 1; %#ok<*VIDREAD>
end_index_xls = 1; % To include header on the top
manual = 1;
show_video = 1;
worm_pos = [];
...
%                         results.Orientation, results.Eccentricity};
    ...
    plot(results.Centroid(1),results.Centroid(2), 'bo');
