...
fig_resolution = 600;
time_difference = 1;
xlsfile = [folder_path file_name(1:end-4) '_all' '.xlsx'];

% Create templates for root concentrations
cen_vel_all = zeros(1020, 3);
cen_vel_header = {};
ang_vel_all = zeros(1020, 2);
ang_vel_header = {};
eul_rate_all = zeros(1020, 2);
eul_rate_header = {};
ext_rate_all = zeros(1020, 2);
ext_rate_header = {};
ecc_rate_all = zeros(1020, 2);
ecc_rate_header = {};
curv_all = zeros(1020, 3);
curv_header = {};
